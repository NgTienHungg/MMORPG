# PHASE 8 — Map & AOI: thế giới có hình dạng và tầm nhìn

> **Kết quả cuối Phase 8:** map có tường thật — client sửa kiểu gì cũng không xuyên được, đi sát tường
...
>
> **Điều kiện:** xong [`PHASE-7.md`](PHASE-7.md) tới CHECKPOINT B và cả 3 thử nghiệm.
>
...
(vẽ hình) cùng đọc **một** định nghĩa — không tồn tại khả năng map hai bên lệch nhau. Phase 9 sẽ đưa
...
### ✅ CHECKPOINT B — mục tiêu cuối Phase 8
...
**Xong Phase 8 → thế giới có tường, có tầm nhìn, băng thông theo mật độ.** [PHASE-9](PHASE-9.md) trả nốt
